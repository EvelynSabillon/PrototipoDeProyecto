...
{
    public partial class SalidaConcentrado : Form
    {
        SqlDataAdapter adpSalidasCon;
        DataTable tabSalidasCon;

        public SalidaConcentrado()
        {
            InitializeComponent();
        }

        public SalidaConcentrado(SqlConnection conexion, int Salidaid)
        {
            InitializeComponent();


            adpSalidasCon = new SqlDataAdapter();

            adpSalidasCon.SelectCommand = new SqlCommand("spSocioSelect", conexion);
            adpSalidasCon.SelectCommand.CommandType = CommandType.StoredProcedure;
            adpSalidasCon.SelectCommand.Parameters.AddWithValue("@Socioid", Salidaid);

            adpSalidasCon.InsertCommand = comando("spSocioInsert", conexion);
            adpSalidasCon.UpdateCommand = comando("spSocioUpdate", conexion);
        ...
        private void SalidaConcentrado_Load(object sender, EventArgs e)
        {
